package com.lc.springboot.common.redis.config;

import com.lc.springboot.common.redis.RedissonProperties;
import com.lc.springboot.common.redis.serializer.RedisObjectSerializer;
...
public class RedisAutoConfig {
    ...
    public LettuceConnectionFactory lettuceConnectionFactory(
        ...
        LettuceConnectionFactory factory =
                new LettuceConnectionFactory(redisConfiguration, clientConfig);
        return factory;
    }
    ...
    public RedisUtil redisUtil(
        ...
        RedisUtil redisUtil =
                new RedisUtil(lettuceConnectionFactory, stringRedisTemplate, hashOperations);
        return redisUtil;
    }

    @Bean(destroyMethod = "shutdown")
    @ConditionalOnProperty(
            name = "spring.redis.redisson.enable",
