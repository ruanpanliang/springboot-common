...
public enum HttpStatus_CN {
   ...
   */
  INTERNAL_SERVER_ERROR(500, "服务器内部出现错误，请联系管理员"),
  /**
  ...
  static {
    for (HttpStatus_CN status_cn : HttpStatus_CN.values()) {
      codeMap.put(status_cn.getCode(), status_cn.getMsg());
    }
  }

  HttpStatus_CN(int code, String msg) {
    this.code = code;
    this.msg = msg;
  }
