 ...
 * the License.
 */
package com.lc.springboot.mybatisplus.generatecode.config.po;

import com.baomidou.mybatisplus.core.toolkit.CollectionUtils;
import com.baomidou.mybatisplus.core.toolkit.StringUtils;
import com.lc.springboot.mybatisplus.generatecode.config.StrategyConfig;
...
public class TableInfo {
    ...
    //  * 是否包含数字类型的字段
    //  */
    // private boolean haveNumericalField;
