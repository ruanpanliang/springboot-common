...
import com.lc.springboot.mybatisplus.generatecode.config.querys.DbQueryRegistry;
import com.lc.springboot.mybatisplus.generatecode.config.converts.TypeConverts;
import lombok.Data;
...
public class DataSourceConfig {
  ...
  public IDbQuery getDbQuery() {
    if (null == dbQuery) {
      ...
      // 默认 MYSQL
      dbQuery =
          Optional.ofNullable(dbQueryRegistry.getDbQuery(dbType))
