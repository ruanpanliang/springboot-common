...
public class CustomCodeGenerator {
  ...
  public static void main(String[] args) {
    ...
    String version = "1.0";
    // 项目名称
    String projectName = "xxxx";
    // 模板名称
    String moduleName = "xxxxxxx";
    // 根包名
    String basePackage = "您的包名." + projectName;
    // 开发人员
    String author = "lc";

    //controller层url映射的根路径地址
    String controllerRootMapPath = String.format("/v1/%s/", projectName);

    // 设置程序代码输出根目录
    String outputRootDir = "/Users/lc/tmp/";
    // 设置代码输出目录
    ...
    //模板文件路径
    String templateDir = "xxxxxx";

    // 数据库配置---------------------
    String dbDriverName = "com.mysql.cj.jdbc.Driver";
    String dbUserName = "root";
    String dbPassword = "xxxx";
    String dbUrl = "jdbc:mysql://localhost:3306/xxxxxx";

    // 表前缀
    String tablePrefix = "xxx";
    // 生成样例代码的表
    // String[] tables = new String[] {"xxxxxx"};
    String[] tables = new String[] {};
    String likeTable = "XXX_";
    ...
    // controller URL 根路径
    gc.setControllerRootMapPath(controllerRootMapPath);
    // 是否开启swagger2
    gc.setSwagger2(true);
    // 是否打开输出目录
    gc.setOpen(true);
    // 设置是否生成feign client客户端代码
    gc.setEnableFeignClient(true);
    ...
    strategy.setSuperEntityClass(
        String.format("%s.common.mybatisplus.model.BaseModel", basePackage));
    // 自定义基础的Entity类，公共字段
